...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Start_auto.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        Stop_auto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                toggleButtons_3();
            }
    ...
    private void toggleButtons_2() {
        if (Start_auto.isEnabled()) {
            Stop_auto.setEnabled(true);
            Start_auto.setEnabled(false);
            aaa=1;
        } else {
            Stop_auto.setEnabled(false);
            Start_auto.setEnabled(true);
            aaa=0;
        }
    }

    private void toggleButtons_3() {
        if (Stop_auto.isEnabled()) {
            Start_auto.setEnabled(true);
            Stop_auto.setEnabled(false);
            aaa=0;
        } else {
    ...
    private void request_post_for_insert() {
        ...
        })
        {
            ...
            protected Map<String,String> getParams(){
                ...
                params.put("id",my_javaclass.name);
                params.put("Lat",Double.toString(mCurrentLocation.getLatitude()));
                params.put("Lng",Double.toString(mCurrentLocation.getLongitude()));
